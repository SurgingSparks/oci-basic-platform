...
resource "oci_core_instance" "basic_platform_vm1" {
  ...
  create_vnic_details {
    ...
    private_ip                   = var.basic_platform_vm1_private_ip
...
resource "oci_core_instance" "basic_platform_vm2" {
  agent_config {
    is_management_disabled  = var.is_management_disabled
    is_monitoring_disabled  = var.is_monitoring_disabled
    plugins_config {
  ...
  availability_domain                  = var.availability_domain
  compartment_id                       = var.compartment_id
  display_name                         = var.basic_platform_vm2_display_name
  shape                                = var.shape
  is_pv_encryption_in_transit_enabled = var.is_pv_encryption_in_transit_enabled
  ...
  create_vnic_details {
    ...
    assign_private_dns_record    = var.assign_private_dns_record
    assign_public_ip             = var.assign_public_ip
    private_ip                   = var.basic_platform_vm2_private_ip
    subnet_id                    = var.subnet_id
  }
